...
def run_fitting(scan_path, scan_lmk_path, fit_scan_result):
    # input scan
    # scan_path = './data/scan.obj'
    # scan_path = './data/20230224023221564.000036.obj'

    # landmarks of the scan
    # scan_lmk_path = './data/scan_lmks.npy'
    # scan_lmk_path = '/Users/leonsima/Documents/PycharmProjects/my_flame/pp_numpy/pp36.npy'
    ...
    # write result
    output_path = join( output_dir, fit_scan_result )
    ...
    # output_path = join( output_dir, scan_scaled )
